...
class PlayerController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        Player::create(['created_by'=>$created_by,'name' => $name,'surname1' => $surname1, 'surname2' => $surname2,'nickname' => $nickname, 'role' => $role, 'description' =>$description, 'image' => $image, 'team_id' => $team_id]);
