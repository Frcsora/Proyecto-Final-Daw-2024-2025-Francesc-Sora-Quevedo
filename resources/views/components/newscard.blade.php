...
<div class="w-64 sm:w-full lg:w-[80%] gap-3 rounded-lg before:rounded-lg tarjeta p-2 flex flex-col justify-around items-center relative before:absolute before:opacity-80 before:bg-[wheat] before:p-2 before:w-full before:h-full before:content[''] before:z-[-1]">
    ...
    <img class="rounded-lg @if('shownews') w-[900%] @else w-80 max-h-48 @endif" src="{{$img}}" alt="{{$name}}">
