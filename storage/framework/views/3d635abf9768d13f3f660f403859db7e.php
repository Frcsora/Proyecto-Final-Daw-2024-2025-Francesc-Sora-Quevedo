...
?>
    <?php if(!empty($tweets)): ?>
    <section class="w-64 md:w-[600px] max-h-[90vh] overflow-y-scroll gap-4 text-base lg:text-2xl flex flex-col justify-around items-center">
...
<?php endif; ?>
<?php /**PATH C:\Users\DEEPGAMING\Desktop\pioesportsbueno\Proyecto-Final-Daw-2024-2025-Francesc-Sora-Quevedo\resources\views/partials/tweets.blade.php ENDPATH**/ ?>