...
<?php $component->withAttributes(['image' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($image),'imageFondo' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($imageFondo),'socialmedias' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($socialmedias),'teams' => \Illuminate\View\Compilers\BladeCompiler::sanitizeComponentAttribute($teams)]); ?>
     <?php $__env->slot('title', null, []); ?> TeamsMedia <?php $__env->endSlot(); ?>
...
<?php $component->withAttributes([]); ?>
            ...
            <form id="formCreateSocialMedia" method="post" action="<?php echo e(route('teamsmedias.store')); ?>">
                <?php echo csrf_field(); ?>
                <input type="hidden" value="<?php echo e(session() -> get('team_id')); ?>" name="team_id">
                <fieldset>
...
<?php endif; ?>
<?php /**PATH /mnt/c/Users/DEEPGAMING/desktop/pioesportsbueno/Proyecto-Final-Daw-2024-2025-Francesc-Sora-Quevedo/resources/views/teamsmedias/create.blade.php ENDPATH**/ ?>