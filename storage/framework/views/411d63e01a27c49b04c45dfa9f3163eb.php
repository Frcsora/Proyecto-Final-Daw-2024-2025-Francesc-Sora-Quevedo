...
<?php $component->withAttributes([]); ?>
            ...
            <form method="post" action="<?php echo e(route('tournaments.update', $tournament->id)); ?>">
                <?php echo method_field('PUT'); ?>
                <?php echo csrf_field(); ?>

                <fieldset>
                    <label for="name">Nombre del torneo:</label><br>
                    <input type="text" name="name" id="name" value="<?php echo e($tournament->name); ?>">
                </fieldset>
                <fieldset>
                    <label for="event">Nombre del evento:</label><br>
                    <input id="event" type="text" name="event" value="<?php echo e($tournament->event); ?>">
                </fieldset>
                <fieldset>
                    ...
                    <select name="team_id" id="team">
                        ...
                        <?php $__currentLoopData = $teams; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $team): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option value="<?php echo e($team->id); ?>" <?php if($team->id == $tournament->team_id): ?> selected <?php endif; ?>><?php echo e($team->name); ?></option>
                        <?php endforeach; $__env->popLoop(); $loop = $__env->getLastLoop(); ?>
                    </select>
                </fieldset>
                <fieldset>
                    <label for="date">Fecha de inicio</label><br>
                    <input id="date" type="date" name="date" value="<?php echo e($tournament->date); ?>">
                    <input name="time" type="time" value="<?php echo e($tournament->time); ?>">
                </fieldset>
                <fieldset>
                    <label for="result">Resultado:</label><br>
                    <input type="number" value="<?php if(isset($tournament->result)): ?> <?php echo e($tournament->result); ?> <?php endif; ?>" name="result">
                </fieldset>
...
<?php endif; ?>
<?php /**PATH /mnt/c/Users/DEEPGAMING/desktop/pioesportsbueno/Proyecto-Final-Daw-2024-2025-Francesc-Sora-Quevedo/resources/views/tournaments/edit.blade.php ENDPATH**/ ?>