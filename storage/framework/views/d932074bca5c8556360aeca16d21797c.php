                    ...
                    <select name="game_id">
                        <?php $__currentLoopData = $games; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $game): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <option value="<?php echo e($game->id); ?>"
                                    <?php if($game->id == $team->game_id): ?>
                                        selected
                                <?php endif; ?>><?php echo e($game->name); ?></option>
...
<?php /**PATH /mnt/c/Users/DEEPGAMING/desktop/pioesportsbueno/Proyecto-Final-Daw-2024-2025-Francesc-Sora-Quevedo/resources/views/teams/edit.blade.php ENDPATH**/ ?>