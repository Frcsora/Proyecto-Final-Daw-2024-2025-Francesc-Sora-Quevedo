...
<?php $component->withAttributes([]); ?>
            ...
            <?php if(Auth::check() && Auth::user()->role !== 'superadmin' && $user->role !== 'superadmin'): ?>
                <form action="<?php echo e(route('users.update', $user->id)); ?>" method="POST">
                    ...
                    <input class="<?php echo e($user->role == 'user' ? 'buttonBlue' : 'buttonRed'); ?>" type="submit" value="<?php echo e($user->role == 'user' ? "Hacer admin": "Quitar admin"); ?>">
                </form>
                <?php echo $__env->make('partials.linea', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
            <?php endif; ?>
            ...
            <?php if(Auth::check() && in_array(Auth::user()->role, ['admin', 'superadmin'])&& $user->role !== 'superadmin'): ?>
                <form action="<?php echo e(route('users.update', $user->id)); ?>" method="POST">
                    ...
                    <input class="<?php echo e($user->active_user == '1' ? "buttonRed": "buttonBlue"); ?>" type="submit" value="<?php echo e($user->active_user == '1' ? "Bloquear": "Desbloquear"); ?>">
                </form>
            <?php endif; ?>
...
<?php endif; ?>
<?php /**PATH /mnt/c/Users/franc/Desktop/piopioesports/piopioesports/resources/views/users/show.blade.php ENDPATH**/ ?>