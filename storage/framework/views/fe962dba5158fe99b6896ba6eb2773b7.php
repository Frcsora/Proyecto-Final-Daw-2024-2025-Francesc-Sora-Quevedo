...
<?php $component->withAttributes([]); ?>
            ...
            <form method="post" action="<?php echo e(route('matches.update', $match->id)); ?>">
                ...
                <fieldset>
                    ...
                    <input id="date" type="date" name="date" value="<?php echo e($match->date); ?>">
                    <input name="time" type="time" value="<?php echo e($match->time); ?>">
                </fieldset>
                <fieldset>
                    <label for="rival">Nombre del equipo rival</label><br>
                    <input type="text" name="rival" value="<?php echo e($match->rival); ?>">
                </fieldset>
                <fieldset>
                    <label class="best_of">Mejor de</label><br>
                    <select name="best_of">
                        <option value="BO1" <?php if($match->best_of == 'BO1'): ?> selected <?php endif; ?>>BO1</option>
                        <option value="BO3" <?php if($match->best_of == 'BO3'): ?> selected <?php endif; ?>>BO3</option>
                        <option value="BO5" <?php if($match->best_of == 'BO5'): ?> selected <?php endif; ?>>BO5</option>
                    </select>
                </fieldset>
                <fieldset>
                    <label for="result">Resultado</label><br>
                    <select name="result">
                        <option value="Pendiente" <?php if($match->result == 'Pendiente'): ?> selected <?php endif; ?>>Pendiente</option>
                        <option value="Victoria" <?php if($match->result == 'Victoria'): ?> selected <?php endif; ?>>Victoria</option>
                        <option value="Empate" <?php if($match->result == 'Empate'): ?> selected <?php endif; ?>>Empate</option>
                        <option value="Derrota" <?php if($match->result == 'Derrota'): ?> selected <?php endif; ?>>Derrota</option>
                    </select>
                </fieldset>
...
<?php endif; ?>
<?php /**PATH /mnt/c/Users/DEEPGAMING/desktop/pioesportsbueno/Proyecto-Final-Daw-2024-2025-Francesc-Sora-Quevedo/resources/views/matches/edit.blade.php ENDPATH**/ ?>