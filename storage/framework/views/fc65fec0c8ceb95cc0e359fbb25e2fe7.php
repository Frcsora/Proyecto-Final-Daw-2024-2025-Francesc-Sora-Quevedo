...
<?php $component->withAttributes([]); ?>
        ...
        <form method="post" action="<?php echo e(route('tags.update', $tag->id)); ?>">
            <?php echo csrf_field(); ?>
            <?php echo method_field('PUT'); ?>
            <label for="tag">Nombre del tag</label>
            <input type="text" id="tag" name="tag" value="<?php echo e($tag->tag); ?>"><br>
...
<?php /**PATH C:\Users\DEEPGAMING\Desktop\pioesportsbueno\Proyecto-Final-Daw-2024-2025-Francesc-Sora-Quevedo\resources\views/tags/edit.blade.php ENDPATH**/ ?>