...
<?php $component->withAttributes([]); ?>
            ...
            <small>Usuario creado el <?php echo e(\Carbon\Carbon::parse($user->created_at->format('d M Y H:m:s'))); ?></small>
            ...
            <?php if(Auth::check() && Auth::user()->role === 'superadmin' && $user->role !== 'superadmin'): ?>
                <form action="<?php echo e(route('users.update', $user->id)); ?>" method="POST">
                    ...
                    <input class="buttonBlue" type="submit" value="<?php echo e($user->role == 'user' ? "Hacer admin": "Quitar admin"); ?>">
                </form>
                <?php echo $__env->make('partials.linea', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
            <?php endif; ?>
            ...
            <?php if(Auth::check() && in_array(Auth::user()->role, ['admin', 'superadmin']) && $user->role !== 'superadmin'): ?>
                <form action="<?php echo e(route('users.update', $user->id)); ?>" method="POST">
                    ...
                    <input class="buttonBlue" type="submit" value="<?php echo e($user->active_user == '1' ? "Bloquear": "Desbloquear"); ?>">
                </form>
            <?php endif; ?>
            <p>Usuario: <?php if($user->active_user == 1): ?>
                    Activo
                          ...
                          Bloqueado
                <?php endif; ?></p>
            <p class="text-base">Correo: <?php echo e($user->email); ?></p>
            <?php echo $__env->make('partials.linea', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?>
...
<?php endif; ?>
<?php /**PATH C:\Users\DEEPGAMING\Desktop\pioesportsbueno\Proyecto-Final-Daw-2024-2025-Francesc-Sora-Quevedo\resources\views/users/show.blade.php ENDPATH**/ ?>