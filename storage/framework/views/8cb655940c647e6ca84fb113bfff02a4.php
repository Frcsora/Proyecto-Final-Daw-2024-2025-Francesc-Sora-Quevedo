            ...
            <?php if(isset($tournaments)): ?>
                ...
                <?php $__currentLoopData = $tournaments; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $tournament): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <section class="flex flex-wrap gap-2">
                        <p ><?php echo e($tournament->event); ?>: <?php echo e($tournament->name); ?>. Fecha de inicio: <?php echo e(\Carbon\Carbon::parse($tournament->date)->format('d/m/Y')); ?> <?php echo e($tournament->time); ?> <?php if(isset($tournament->result)): ?> Posición: <?php echo e($tournament->result); ?> <?php endif; ?></p>
