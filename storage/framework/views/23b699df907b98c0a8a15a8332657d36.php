...
<?php $component->withAttributes([]); ?>
            ...
            <form id="formCreateSocialMedia" method="post" action="<?php echo e(route('teamsmedias.store')); ?>">
                <?php echo csrf_field(); ?>
                <input type="hidden" value="<?php echo e($id); ?>" name="team_id">
                <fieldset>
...
<?php endif; ?>
<?php /**PATH /mnt/c/Users/franc/Desktop/piopioesports/piopioesports/resources/views/teamsmedias/create.blade.php ENDPATH**/ ?>