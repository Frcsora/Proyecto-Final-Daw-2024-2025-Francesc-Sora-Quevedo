...
<?php $component->withAttributes([]); ?>
            ...
            <?php if(isset($tournaments)): ?>
                ...
                <?php $__currentLoopData = $tournaments; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $tournament): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                    <section class="flex flex-wrap gap-2">
                        <p><a href="<?php echo e(route('tournaments.show', $tournament->id)); ?>"><?php echo e($tournament->event); ?>: <?php echo e($tournament->name); ?>.</a> Fecha de inicio: <?php echo e(\Carbon\Carbon::parse($tournament->date)->format('d/m/Y')); ?> <?php echo e($tournament->time); ?> <?php if(isset($tournament->result)): ?> Posición: <?php echo e($tournament->result); ?> <?php endif; ?></p>
            ...
            <?php if(Auth::check()): ?>
                <?php if(in_array(Auth::user()->role, ['admin', 'superadmin'])): ?>
                    <form method="get" action="<?php echo e(route('teamsmedias.create')); ?>">
...
<?php /**PATH C:\Users\DEEPGAMING\Desktop\pioesportsbueno\Proyecto-Final-Daw-2024-2025-Francesc-Sora-Quevedo\resources\views/teams/show.blade.php ENDPATH**/ ?>